...
<body>
  ...
  <div class="container">
    ...
    <br>
      <div class="col-md-6" style="padding-left: 125px; margin-top: 10px;">
        <div class="card" style="width: 18rem; margin-left:30px;">
          <img src="Images/SSS.png" class="card-img-top" alt="SSS">
          <div class="card-body">
            <p class="card-text text-center">S SREENIVASA SHENOY <br>4CB19CS087</p>
          </div>
        </div>
      </div>
      <div class="col-md-6" style="padding-left: 125px; margin-top: 10px;">
        <div class="card" style="width: 18rem; margin-left:80px;">
          <img src="Images/PP.png" class="card-img-top" alt="PP">
          <div class="card-body">
            <p class="card-text text-center">P PADMAPRASAD SHENOY <br>4CB19CS064</p>
          </div>
        </div>
      </div>
    </div>
