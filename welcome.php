...
<body>
  ...
  <h4 id="mem">
    ...
    <div class="d-flex" style="width:40%">
      <input class="form-control me-2" type="search" name="valid_user" autocomplete="off" placeholder="Enter your ID" aria-label="ID" required>
      <button class="btn" style="border:1px solid white; background:#0099e6; color:white;" type="submit" name="submit"><i class="fas fa-arrow-right"></i></button>
    </div>
  </form>
    </center>
    <br>
